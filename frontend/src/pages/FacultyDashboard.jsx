                      ...
                      <td key={pIdx} style={{ padding: '0.5rem', height: '80px', borderRight: pIdx !== 6 ? '1px solid var(--border)' : 'none', verticalAlign: 'middle' }}>
                        {period && period.subject && period.subject !== '-' ? (
                          ...
                          >
                            ...
                            {period.faculty && !viewingTimetable.isPersonal && (
                              <span className="text-xs text-muted mt-1">{typeof period.faculty === 'object' ? period.faculty.name : period.faculty}</span>
                            )}
                            {period.lab && (
